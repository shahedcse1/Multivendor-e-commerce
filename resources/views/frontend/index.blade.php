    ...
    <section class="home-banner-area mb-4" >
        <div class="container">
            <div class="row no-gutters position-relative" >
                <div class="col-lg-3 position-static order-2 order-lg-0" style="margin-top:5px;">
                    <div class="category-sidebar">
                        <div class="all-category d-none d-lg-block">
                            <span >{{ translate('Categories') }}</span>
                            <a href="{{ route('categories.all') }}">
                                <span class="d-none d-lg-inline-block"><button type="button" class="btn btn-default" style="background-color:#fff;color:#000;">See All </button></span>
                            </a>
                        </div>
                ...
                <div class="col-lg-9 order-1 order-lg-0 @if(count($featured_categories) == 0) home-slider-full @endif" style="margin-top:5px;">
